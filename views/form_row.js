...
SandBox.FormRowView = SC.View.extend(SandBox.FlowedLayout, SandBox.CalculatesEmptiness, SandBox.FormsEditMode,
/** @scope Forms.FormRowView.prototype */ {
  ...
  */
  createChildViews: function()
  {
    ...
    //if (!content) console.log('I have no content!!');
...
SandBox.FormRowView.prototype.labelView = SandBox.FormRowView.LabelView.design();
